...
mkt_fte = n(live('Yearly marketing budget one marketer can run'))
...
c_comm = n(live('Trainer, order desk, marketing')); c_ops = n(live('Supply chain and production'))c_tech = n(live('Field service engineer'))
